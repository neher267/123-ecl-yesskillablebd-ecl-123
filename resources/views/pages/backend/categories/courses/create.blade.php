            ...
            <div class="x_content">
                ...
                <form 
                   ...
                   <!--  <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <textarea name="title" id="title" required class="form-control col-md-9 col-xs-12"></textarea>
                        </div>
                    </div> -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input type="number" id="duration" name="duration" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input type="number" id="fee" name="fee" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>   
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <textarea name="summary" id="summary" required class="form-control col-md-9 col-xs-12"></textarea>
                        </div>
                    </div>
                    ...
                    <!-- <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <textarea name="job_opp" id="job_opp"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <textarea name="enroll" id="enroll"></textarea>
                        </div>
                    </div>   -->                  
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input type="file" id="thumnail" name="thumnail" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    ...
                    <!-- <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input type="file" id="background" name="background" required="required"  class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
