            ...
            <div class="x_content">
                ...
                <form action="{{route('services.update', $result)}}" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <select id="is_trining" name="is_trining" required="required" class="form-control col-md-7 col-xs-12">
                                <option value="0" {{$result->is_trining == 0 ? "selected":""}}>No</option>
                                <option value="1" {{$result->is_trining == 1 ? "selected":""}}>Yes</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input type="color" id="color" name="color"  value="{{$result->color != '' ? $result->color:'#000000'}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input type="color" id="background_color" name="background_color"  value="{{$result->background_color != '' ? $result->background_color:'#ffffff'}}">
                        </div>
                    </div>
