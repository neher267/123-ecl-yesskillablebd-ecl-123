...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />
                <form action="{{route('images.store')}}" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input type="file" id="src" name="src" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input type="text" id="priority" name="priority" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
