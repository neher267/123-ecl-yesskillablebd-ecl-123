        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form action="{{route('products.update', $result)}}" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <select id="brand_id" name="brand_id" required class="form-control col-md-7 col-xs-12">
                                ...
                                <option value="{{$brand->id}}" {{$result->brand_id == $brand->id ? 'selected':''}}>{{$brand->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input value="{{$result->order}}"  type="text" id="order" name="order" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="image">Image2
                        </label>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            @if(!empty($result->image2))
                            <img src="{{asset($result->image2)}}" style="margin: 15px 0px; height: 200px; width: 350px">
                            @endif
                            <input type="file" id="image" name="image2" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="image3">Image3
                        </label>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            @if(!empty($result->image3))
                            <img src="{{asset($result->image3)}}" style="margin: 15px 0px; height: 200px;">
                            @endif
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="image4">Image4
                        </label>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            @if(!empty($result->image4))
                            <img src="{{asset($result->image4)}}" style="margin: 15px 0px; height: 200px;">
                            @endif
